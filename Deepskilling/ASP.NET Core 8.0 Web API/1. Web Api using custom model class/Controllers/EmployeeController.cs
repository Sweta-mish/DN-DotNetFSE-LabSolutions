...
using _1._Web_Api_using_custom_model_class.Models;
using _1._Web_Api_using_custom_model_class.Filters;

namespace _1._Web_Api_using_custom_model_class.Controllers
{
    [ApiController]
    [Route("[controller]")]
